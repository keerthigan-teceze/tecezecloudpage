...
<style>
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .ci-hero {
   ...
   background-image: url('/images/application.png'); /* ← ADD BG IMAGE HERE */
...
<section class="ci-hero">
  <div class="ci-hero-content">
    ...
    <div class="ci-top-row">
      <p class="ci-hero-breadcrumb">WHAT WE DO/APPLICATION DEVELOPMENT</p>
      <div></div>
    </div>
    ...
    <div class="ci-body-row">
      ...
      <div class="ci-hero-left">
        <h1 class="ci-hero-title">Build, Modernize, and Scale Secure Enterprise Applications</h1>
        <p class="ci-hero-sub">From strategy and design to deployment and ongoing support, scalable and secure applications are engineered to drive performance, resilience, and business growth.</p>
...
<section class="ci-overview">
  <div class="ci-overview-wrapper">
    ...
    <div class="ci-overview-content">
      ...
      <h2 class="ci-overview-title">Enterprise Applications Built for Performance and Scale</h2>

      <p class="ci-overview-desc">Whether modernizing legacy systems or developing new platforms, applications are built to deliver agility, performance, and long-term scalability.</p>
      ...
      <div class="ci-overview-statement">
        <p class="ci-statement-text">
          <span>AI-driven monitoring and real-time threat detection help </span>
          <span class="ci-statement-grey">protect applications, reduce risk, and ensure the continuous availability of business-critical systems.</span>
        </p>
      </div>
...
<section class="clc-section" aria-label="Cloud Lifecycle Management">
  <div class="clc-inner">
    ...
    <!-- ── TOP LEFT ── -->
    <div class="clc-badge">
      <p class="clc-badge__text">Built for <br>Performance</p>
    </div>

    <!-- ── TOP RIGHT ── -->
    <div class="clc-heading">
      <h2 class="clc-heading__title">Our Delivery Methodology</h2>
      <p  class="clc-heading__sub">A structured approach ensures consistency, quality, and efficiency across the application lifecycle.</p>
    </div>
...
Security Metrics</p>
  ...
  <div class="opr-grid">
    ...
    <div class="opr-card opr-card--1">
      <h3 class="opr-card__title">1.&nbsp; Proven Expertise</h3>
    ...
    <div class="opr-card opr-card--2">
      ...
      <h3 class="opr-card__title">2.&nbsp; Agile & Scalable</h3>
...
accountability.</p>
    ...
    <div class="opr-card opr-card--3">
      ...
      <h3 class="opr-card__title">3.&nbsp; Cost-Effective</h3>
    ...
    <div class="opr-card opr-card--4">
      <h3 class="opr-card__title">4.&nbsp; Security First</h3>
...
<section class="drv-section">
  <div class="drv-inner">
    ...
    <div class="drv-top">
      <h2 class="drv-headline">Measurable Application Performance</h2>
      <p class="drv-desc">
        Application environments are optimized to improve performance, accelerate delivery, and enhance operational efficiency across development and deployment cycles.
      </p>
    </div>
    ...
    <div class="drv-cards-wrap">
      ...
      <div class="drv-row drv-row--70-30">
        ...
        <div class="drv-box">
          <p class="drv-box__text">Delivering scalable applications with measurable impact on performance and delivery timelines. </p>
          <div class="drv-box__stat-wrap">
            <span class="drv-box__label">Faster Product Launches</span>
        ...
        <div class="drv-box">
          <div class="drv-box__stat-wrap">
            <span class="drv-box__label">Team Efficiency</span>
            <span class="drv-box__stat">2x</span>
          </div>
          <p class="drv-box__text">Experienced teams enabling innovation across complex enterprise application environments.</p>
        </div>
      ...
      <div class="drv-row drv-row--30-70">
        ...
        <div class="drv-box">
          <p class="drv-box__text">Supporting intuitive application design and seamless user experiences.</p>
          <div class="drv-box__stat-wrap">
            <span class="drv-box__label">User Adoption</span>
        ...
        <div class="drv-box">
          <div class="drv-box__stat-wrap">
            <span class="drv-box__label">Lower Operating Costs</span>
            <span class="drv-box__stat">30%</span>
          </div>
          <p class="drv-box__text">Optimized development and infrastructure strategies reduce operational expenses.</p>
        </div>
...
(function(){
  var SLIDES = [
    {
      meta: 'Global enterprise network transformation',
      leftTitle: 'Deployed a fully automated SD-WAN and network monitoring solution for a Fortune 500 enterprise across 40+ countries.',
    ...
    {
      meta: 'Secure cloud deployment for BFSI',
      leftTitle: 'Designed and executed a zero-trust security',
  ...
  <style>
    *, *::before, *::after {
    ...
    .te-section {
      ...
      background-image: url('https://teal-mule-553916.hostingersite.com/images/Ai-tools-bg-img.jpg');
      background-size: cover;
      background-position: center;
      background-repeat: no-repeat;
    }
...
<section class="te-section">
  ...
  <div class="te-container">
    ...
    <!-- LEFT COLUMN -->
    <div class="te-left">
      <p class="te-left__label">Industries Supported</p>
      <h2 class="te-left__heading">Industries We Enable</h2>
      <p class="te-left__desc">
       Delivering tailored application solutions that address industry-specific challenges, improve efficiency, and support digital transformation.
      </p>
