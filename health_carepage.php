    ...
    <style>
      ...
      .bg-hero-overlay {
        background:
          ...
          url("images/healthcare_hero.jpg");
  ...
  <body class="text-white bg-[#011627]">
    ...
    >
      ...
      >
        <div class="relative group mx-auto">
          ...
          ></div>
          <img
            src="images/healthcare_about.jpg"
        ...
        <div class="space-y-4 sm:space-y-6 text-[#1a2b3c] px-4 sm:px-0">
          <div class="text-sm sm:text-md md:text-2xl leading-[1.5] font-medium">
            <span class="font-semibold text-[#011627]"
              >Teceze delivers intelligent IT infrastructure for healthcare,
          ...
          <div class="space-y-1 sm:space-y-2">
            ...
            <div class="faq-item border-b border-gray-100 py-4 sm:py-6">
              ...
              >
                ...
                >
                  Teceze Offers Comprehensive IT Solutions Including
                  Cybersecurity, Managed IT Services, Digital Transformation,
                  And AI-Driven Automation Tailored To Enterprise Needs.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item border-b border-gray-100 py-4 sm:py-6">
              ...
              >
                <p
                  class="text-xs sm:text-sm text-gray-400 leading-relaxed max-w-lg"
                >
                  Yes, Teceze operates globally, providing robust IT solutions
                  and support for enterprises across multiple regions to ensure
                  seamless operations.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item border-b border-gray-100 py-4 sm:py-6">
              ...
              >
                <p
                  class="text-xs sm:text-sm text-gray-400 leading-relaxed max-w-lg"
                >
                  You can get started by contacting our team through the
                  "Connect With Us" or "Let's Talk" buttons on our website, and
                  we will schedule an initial consultation to understand your
                  needs.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item border-b border-gray-100 py-4 sm:py-6">
              ...
              >
                <p
                  class="text-xs sm:text-sm text-gray-400 leading-relaxed max-w-lg"
                >
                  Absolutely. We tailor our IT and cybersecurity solutions to
                  fit the specific requirements, scale, and compliance needs of
                  your enterprise.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item border-b border-gray-100 py-4 sm:py-6">
              ...
              >
                <p
                  class="text-xs sm:text-sm text-gray-400 leading-relaxed max-w-lg"
                >
                  Yes, our dedicated Security Operations Center (SOC) provides
                  24/7 real-time monitoring and rapid threat response to keep
                  your data secure.
                </p>
              </div>
            </div>
    ...
    <script>
      ...
      const capabilitiesData = [
        {
          ...
          description:
            "Seamless integration of clinical systems and medical devices to enable real-time, accurate decision-making.",
          ...
          image: "images/healthcare_capabilities-5.jpg",
        },

        {
          type: "image",
          category: "PLATFORMS",
          title: "EHR & Digital Health Platforms",
          description:
            "mplementation and integration of Electronic Health Record systems and digital health platforms that centralise patient data, streamline clinical workflows, and improve care coordination across departments.",
          image: "images/healthcare_capabilities-1.jpg",
...

        {
          ...
          description:
            "Healthcare-grade cybersecurity frameworks ensure patient data is protected, access is controlled, and organisations remain fully compliant with HIPAA, GDPR, and other healthcare data regulations.",
          image: "images/healthcare_capabilities-2.jpg",
...

        {
          ...
24.2038 36.944 24.375 37.375 24.375H38.9188C38.5384 28.1026 36.8839 31.5849 34.2344 34.2344C31.5849 36.8839 28.1026 38.5384 24.375 38.9188ZM22.75 14.625C21.143 14.625 19.5721 15.1015 18.236 15.9943C16.8998 16.8871 15.8584 18.156 15.2435 19.6407C14.6285 21.1253 14.4676 22.759 14.7811 24.3351C15.0946 25.9112 15.8685 27.3589 17.0048 28.4952C18.1411 29.6315 19.5888 30.4054 21.1649 30.7189C22.741 31.0324 24.3747 30.8715 25.8593 30.2565C27.344 29.6416 28.6129 28.6002 29.5057 27.264C30.3985 25.9279 30.875 24.357 30.875 22.75C30.875 20.5951 30.019 18.5285 28.4952 17.0048C26.9715 15.481 24.9049 14.625 22.75 14.625ZM22.75 27.625C21.7858 27.625 20.8433 27.3391 20.0416 26.8034C19.2399 26.2677 18.6151 25.5064 18.2461 24.6156C17.8771 23.7248 17.7806 22.7446 17.9687 21.7989C18.1568 20.8533 18.6211 19.9846 19.3029 19.3029C19.9846 18.6211 20.8533 18.1568 21.7989 17.9687C22.7446 17.7806 23.7248 17.8771 24.6156 18.2461C25.5064 18.6151 26.2677 19.2399 26.8034 20.0416C27.3391 20.8433 27.625 21.7858 27.625 22.75C27.625 24.0429 27.1114 25.2829 26.1971 26.1971C25.2829 27.1114 24.0429 27.625 22.75 27.625Z",
        },

        {
          ...
          description:
            "Advanced analytics and AI-powered tools that help healthcare organisations predict patient outcomes, optimise resource allocation, reduce readmissions, and support more informed clinical decision-making.",
          image: "images/healthcare_capabilities-4.jpg",
          icon: "M13 22.75V19.5C13 19.069 13.1712 18.6557 13.476 18.351C13.7807 18.0462 14.194 17.875 14.625 17.875C15.056 17.875 15.4693 18.0462 15.774 18.351C16.0788 18.6557 16.25 19.069 16.25 19.5V22.75C16.25 23.181 16.0788 23.5943 15.774 23.899C15.4693 24.2038 15.056 24.375 14.625 24.375C14.194 24.375 13.7807 24.2038 13.476 23.899C13.1712 23.5943 13 23.181 13 22.75ZM21.125 24.375C21.556 24.375 21.9693 24.2038 22.274 23.899C22.5788 23.5943 22.75 23.181 22.75 22.75V17.875C22.75 17.444 22.5788 17.0307 22.274 16.726C21.9693 16.4212 21.556 16.25 21.125 16.25C20.694 16.25 20.2807 16.4212 19.976 16.726C19.6712 17.0307 19.5 17.444 19.5 17.875V22.75C19.5 23.181 19.6712 23.5943 19.976 23.899C20.2807 24.2038 20.694 24.375 21.125 24.375ZM27.625 24.375C28.056 24.375 28.4693 24.2038 28.774 23.899C29.0788 23.5943 29.25 23.181 29.25 22.75V16.25C29.25 15.819 29.0788 15.4057 28.774 15.101C28.4693 14.7962 28.056 14.625 27.625 14.625C27.194 14.625 26.7807 14.7962 26.476 15.101C26.1712 15.4057 26 15.819 26 16.25V22.75C26 23.181 26.1712 23.5943 26.476 23.899C26.7807 24.2038 27.194 24.375 27.625 24.375ZM39 9.75V29.25H40.625C41.056 29.25 41.4693 29.4212 41.774 29.7259C42.0788 30.0307 42.25 30.444 42.25 30.875C42.25 31.306 42.0788 31.7193 41.774 32.024C41.4693 32.3288 41.056 32.5 40.625 32.5H22.75V36.0303C23.8342 36.4136 24.748 37.1679 25.3299 38.1598C25.9118 39.1518 26.1243 40.3174 25.9298 41.4509C25.7353 42.5843 25.1464 43.6125 24.2672 44.3537C23.388 45.095 22.275 45.5015 21.125 45.5015C19.975 45.5015 18.862 45.095 17.9828 44.3537C17.1036 43.6125 16.5147 42.5843 16.3202 41.4509C16.1257 40.3174 16.3382 39.1518 16.9201 38.1598C17.502 37.1679 18.4158 36.4136 19.5 36.0303V32.5H1.625C1.19402 32.5 0.780698 32.3288 0.475951 32.024C0.171205 31.7193 0 31.306 0 30.875C0 30.444 0.171205 30.0307 0.475951 29.7259C0.780698 29.4212 1.19402 29.25 1.625 29.25H3.25V9.75C2.38805 9.75 1.5614 9.40759 0.951903 8.7981C0.34241 8.1886 0 7.36195 0 6.5V3.25C0 2.38805 0.34241 1.5614 0.951903 0.951903C1.5614 0.34241 2.38805 0 3.25 0H39C39.862 0 40.6886 0.34241 41.2981 0.951903C41.9076 1.5614 42.25 2.38805 42.25 3.25V6.5C42.25 7.36195 41.9076 8.1886 41.2981 8.7981C40.6886 9.40759 39.862 9.75 39 9.75ZM22.75 40.625C22.75 40.3036 22.6547 39.9894 22.4761 39.7222C22.2976 39.455 22.0438 39.2467 21.7469 39.1237C21.4499 39.0007 21.1232 38.9685 20.808 39.0312C20.4928 39.0939 20.2032 39.2487 19.976 39.4759C19.7487 39.7032 19.5939 39.9928 19.5312 40.308C19.4685 40.6232 19.5007 40.9499 19.6237 41.2469C19.7467 41.5438 19.955 41.7976 20.2222 41.9761C20.4894 42.1547 20.8036 42.25 21.125 42.25C21.556 42.25 21.9693 42.0788 22.274 41.774C22.5788 41.4693 22.75 41.056 22.75 40.625ZM3.25 6.5H39V3.25H3.25V6.5ZM35.75 9.75H6.5V29.25H35.75V9.75Z",
        },
      ];
      ...
      const caseStudiesData = [
        {
          ...
          image: "images/01-health-case-study-img.png",
        ...
        },
        {
          ...
          image: "images/02-health-case-study-img.png",
        ...
        {
          title:
            "Developed a custom patient engagement application integrating appointment booking, medical records access, and remote consultation, significantly enabling care teams to focus more time on clinical outcomes.",
          topLabel: "App & Software Development for Healthcare",
          image: "images/03-health-case-study-img.png",
      ...
      const insightsData = [
        {
          featured: {
            image: "images/healthcare_latest_insights-1.jpg",
          ...
          articles: [
            {
              image: "images/healthcare_latest_insights-2.jpg",
              date: "Dec 16, 2025, IT Service",
              title: "How Managed IT Services Improve Business Continuity",
            },
            {
              image: "images/healthcare_latest_insights-3.jpg",
